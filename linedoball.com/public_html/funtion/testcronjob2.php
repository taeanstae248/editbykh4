...
require_once  ('../config.php');
  ...
  global $conn;
      ...
      $a=$table[0];
       ...
       $query = "UPDATE tbl_tded_program SET tded_program='$a',tded_date = NOW(),status='1' where id='1'";
        $result1 = $conn->query($query) or die("Error in Query".$conn->error);


    }
    function Cronjobinserttables2(){
    global $conn;
      ...
      $yd=date('Y-m-d',strtotime("+1 day"));
       $query = "UPDATE tbl_tded_program SET tded_program='$a',tded_date = '$yd',status='1' where id='4'";
        $result1 = $conn->query($query) or die("Error in Query".$conn->error);


    }
    function Cronjobinserttables3(){
    global $conn;
      ...
      $yd=date('Y-m-d',strtotime("-1 day"));
       $query = "UPDATE tbl_tded_program SET tded_program='$a',tded_date = '$yd',status='1' where id='2'";
        $result1 = $conn->query($query) or die("Error in Query".$conn->error);

        $sql = " DELETE FROM `teamvs` WHERE TIMESTAMPDIFF(MINUTE,NOW(),datetime_exp) <-135 ";
...
Cronjobinserttable();
Cronjobinserttables2();
Cronjobinserttables3();
