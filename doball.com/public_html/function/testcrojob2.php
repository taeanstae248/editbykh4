...
$dir['root'] = dirname(str_replace("\\",'/',dirname(__FILE__)))."/";
 ...
 function CronjobTopscorebackBalls2(){
   ...
   $a=$table[0];
     ...
     $strSQL = "SELECT * FROM tbl_tded_program  WHERE  status='0' AND tded_date='$yd' ";
...
$strSQL = "INSERT INTO tbl_tded_program ";
$strSQL .="(id,tded_program,tded_date,status) ";
$strSQL .="VALUES ('','$a','$yd','') ";
