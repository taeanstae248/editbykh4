        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="well">
                    ...
                    <?php
                    $strSQL = "select id, id_team ,date_team, time_team, name_team, link_team from team";
                    ...
                    <table class="table table-striped" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" >วันถ่ายทอดสด</th>
                                <th class="text-center" >เวลาถ่ายทอดสด</th>
                                <th class="text-center" >ชื่อคู่ที่ลงแข่ง</th>
                                <th class="text-center" >อัพลิงค์ถ่ายทอดทางChannel</th>
                        ...
                        <tbody>
                            ...
                            while ($objResult = mysql_fetch_array($result)) {
                                if ($objResult["date_team"]) {
                                    list($year, $month, $day) = explode("-", $objResult["date_team"]);
                                    $objResult["date_team"] = $day . '/' . $month . '/' . ($year + 543);
                                }
                                ?>
                                <tr>
                                    ...
                                    <td class="text-center" ><?php echo $objResult["id_team"]; ?></td>
                                    <td class="text-center" ><?php echo $objResult["date_team"]; ?></td>
                                    <td class="text-center" ><?php echo $objResult["time_team"]; ?></td>
                                    <td class="text-center" ><?php echo $objResult["name_team"]; ?></td>
                                    <td class="text-center" ><?php echo $objResult["link_team"]; ?></td>
                                    <td class="text-center" ><a href="Data_emp.php?id=<?php echo $objResult["id"]; ?>"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;แก้ไข</button></a></td>
                                    <td class="text-center" ><a href="delete.php?id=<?php echo $objResult["id"] ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;&nbsp;ลบ</button></a></td>
                                </tr>
                                <?php
                                $num++;
                            }
        ...
        <script>
            ...
            function deleteSelect() {
				...
				if (result) {
					...
					console.log('---------------');
					//console.log(obj);
					window.location.href = 'delete.php?id=' + obj;
            ...
            function deleteAll() {
				...
				if (result) {
					window.location.href = 'delete.php?task=deleteall';
