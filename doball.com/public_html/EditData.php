        ...
        <div class="form-top-left" >
          <div class="col-sm-9 font1">
            ...
            <div class="container-fluid">
              ...
              <?php
              $show="select * from press where id='$id'";
                ...
                <div class="well">
                  <form name="form1" method="post" action="" enctype="multipart/form-data">
                    <center><div class="form-group">
                      <label class="col-md-7 control-label" for="name"><h3>รายการแข่งขันฟุตบอล :</h3></label>  
                      <div class="col-md-5">
                        <select type="text" id="txtName" name="txtName"  placeholder="----กรุณากรอกลีกทีมฟุตบอล----" class="form-control input-md" value="<?php echo $data["id_team "] ?>"></input>
                            </div>
                          </div></center>
                          <br><br>
                          <!-- end: form -->
                    ...
                    if(isset($_POST["submit"])){ 
                      ...
                      $str="update press set id_team='$AtxtName' where id='$id'";
                      $insert=mysql_query($str)or die("Not update");
                      if($insert){
                        echo "success";
                        echo '<meta http-equiv="refresh" content="0;url=press.php">';
                      }
                    }
                    ?>
